...
describe('Server Routes', () => {
  ...
  it('should respond index page', async () => {
    const response = await client().get('/')
    expect(response.status).toEqual(302)
  })

  it('should respond favicon', async () => {
  ...
  it('should respond movies page', async () => {
  ...
  it('should respond movie page', async () => {
  ...
  it('should respond persons page', async () => {
  ...
  it('should respond person page', async () => {
