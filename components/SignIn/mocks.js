...
export const setUsername = (wrapper, value) =>
  wrapper.find('input[type="text"]').props().onChange({ currentTarget: { value: value || username } })
export const setPassword = (wrapper, value) =>
  wrapper.find('input[type="password"]').props().onChange({ currentTarget: { value: value || password } })
