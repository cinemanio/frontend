...
export const setEmail = (wrapper, value) => wrapper
  .find('input[id="email"]').props().onChange(value || variables.email)
export const setPassword = (wrapper, value) => wrapper
  .find('input[type="password"]').first().props().onChange(value || variables.password)
export const setPasswordConfirm = (wrapper, value) => wrapper
  .find('input[type="password"]').last().props().onChange(value || variables.password)
